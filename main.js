    ...
    function convertToImage() {
        ...
        $('img.media').on('load', function() {
            ...
            if (totalFinish == maximumImages + 1) {
                ...
                html2canvas(document.querySelector("#capture"), { scale: 4, allowTaint: true, useCORS: true }).then(function(canvas) {
        ...
        function frame(full) {
            if (width >= 100) {
                ...
                if (full === 100) {
                    full = maximumImages + 3;
                }
                width = full / (maximumImages + 3) * 100;
