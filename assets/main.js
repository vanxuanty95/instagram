$(document).ready(function () {
    ...
    function run(username, decription) {
        const url = setUpQuery(username, decription);
        fetch(url)
    ...
    function setUpQuery(username, decription) {
        const api = 'https://www.googleapis.com/pagespeedonline/v5/runPagespeed';
        const parameters = {
            url: 'http://instagram.nakamadressup.com/' + encodeURIComponent('index.php?controller=profile&action=profile&username=' + username + '&description=' + decription) + '&key=AIzaSyBWV5zDYDRuX1clPEcadJIdriT62ejesiI',
